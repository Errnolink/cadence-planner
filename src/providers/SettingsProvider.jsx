...
import { SettingsContext } from '../hooks/useSettings.jsx'

// Only the provider reads these, so they live with it rather than beside the
// hook — keeping the hook file free of non-component exports it does not need.
