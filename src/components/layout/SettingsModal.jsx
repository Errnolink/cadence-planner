  ...
  return (
    <Modal title="SYSTEM SETTINGS" hex="0xS001" onClose={onClose}>
      <div className="p-1">
        ...
        {/* ACTIONS */}
        <div className="flex justify-between items-center mt-6 pt-4" style={{ borderTop: '1px solid var(--cad-border-dim)' }}>
          <a
            href="https://github.com/Errnolink"
            target="_blank"
            rel="noopener noreferrer"
            className="px-3 py-1.5 panel-chamfer-sm flex items-center gap-2 hover:opacity-80 transition-opacity"
            style={{
              fontFamily:   'var(--cad-font-mono)',
              fontSize:     '10px',
              letterSpacing:'0.1em',
